      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-gray-400 text-base sm:text-lg leading-relaxed mt-6 mb-8">
            ...
            user-centric design and modern UI/UX. With a solid foundation in
            graphic design and problem solving through data structures and
            algorithms, I bring creativity and logic together to build
